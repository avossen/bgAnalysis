...
void doAnalysisCampaign16()
{
  ...
  //same scale factor. If correct we have for SAD (touschek and Coulomb) only 100us, only 10 for RBB?
  float scaleFactorPhase2=56.0/50000;
  float scaleFactorPhase3=56.0/50000;
 ...
 //
  ...
  //  TFile phase2("../campaign16_phase2/out16_phase2_sum.root");
  TFile phase2("../campaign16_phase2/sum16_phase2_nakayama.root");
  //  TFile phase3("../campaign16_phase3/sum16_phase3_nakayama.root");
  TFile phase3("../sumOut16_phase3.root");
